...
let ArticlesController = class ArticlesController {
    ...
    getArticles(status, category, search) {
        return this.articlesService.getArticles(status, category, search);
    }
    getArticle(id) { return this.articlesService.getArticle(id); }
    createArticle(data) { return this.articlesService.createArticle(data); }
    updateArticle(id, data) { return this.articlesService.updateArticle(id, data); }
    deleteArticle(id) { return this.articlesService.deleteArticle(id); }
};
