...
let StorageService = class StorageService {
    ...
    constructor(configService) {
        ...
        cloudinary_1.v2.config({
            cloud_name: this.configService.get('CLOUDINARY_CLOUD_NAME') || 'mock-cloud',
            api_key: this.configService.get('CLOUDINARY_API_KEY') || 'mock-key',
            api_secret: this.configService.get('CLOUDINARY_API_SECRET') || 'mock-secret',
        });
    }
