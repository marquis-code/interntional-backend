    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: universe_schema_1.University.name, schema: universe_schema_1.UniversitySchema },
                { name: universe_schema_1.Programme.name, schema: universe_schema_1.ProgrammeSchema },
                { name: universe_schema_1.Student.name, schema: universe_schema_1.StudentSchema },
            ]),
        ],
